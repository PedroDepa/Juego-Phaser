...
export class Play2 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("tilesBelow2", "public/assets/imagines/sky_atlas.png");
    this.load.image("tilesPlatform2", "public/assets/imagines/platform_atlas.png");
  }
  ...
  create() {
    ...
    const belowLayer = map2.createLayer("sky", tilesetBelow2, 0, 0);
